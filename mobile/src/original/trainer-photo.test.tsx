...
describe('mobile professional photo boundary', () => {
  ...
  it('keeps the current photo in form data and exposes an explicit web edit, not an editable URL', () => {
    ...
    expect(html).not.toContain('type="url"'); expect(html).toContain('https://web.example.invalid/coach/profile'); expect(html).toContain('Open on the web')
  })
})
