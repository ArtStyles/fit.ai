...
describe('trainer security database harness', () => {
  ...
  it('reapplies trainer migrations through 057 after a locked professional fixture and compares an immutable snapshot', async () => {
    ...
    const rerun = source.indexOf('reapplying trainer migrations 040-051, 053, 056, 057 after locked professional data')
