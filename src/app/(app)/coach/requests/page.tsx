...
export default async function CoachRequestsPage() {
  ...
  return <div className="min-h-screen bg-background pb-28">
    ...
    <main className="mx-auto max-w-4xl px-4 py-8">
      {error ? <p role="alert" className="rounded-2xl border border-red-500/30 p-4 text-sm text-foreground">No se pudieron cargar las solicitudes. Inténtalo de nuevo más tarde.</p> : <CoachRequestQueue requests={requests} />}
