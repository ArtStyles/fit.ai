  ...
  return (
    ...
    >
      ...
      <p className="mt-7 text-center text-xs leading-6 text-muted-foreground">
        ...
        <Link href="/privacy" className="rounded-sm underline underline-offset-4 transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400">Política de privacidad</Link>.
      </p>
    </AuthShell>
  )
}
