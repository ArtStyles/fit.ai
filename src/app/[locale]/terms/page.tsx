...
export default function EnglishTermsPage({ params }: { params: { locale: string } }) {
  return <LegalDocumentPage paramsLocale={params.locale} expectedLocale="en" document="terms" />
}
