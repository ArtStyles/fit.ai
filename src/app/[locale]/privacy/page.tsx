...
export default function EnglishPrivacyPage({ params }: { params: { locale: string } }) {
  return <LegalDocumentPage paramsLocale={params.locale} expectedLocale="en" document="privacy" />
}
