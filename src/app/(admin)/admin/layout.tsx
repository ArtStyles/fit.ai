...
import { countAdminTrainerApplicationsRequiringAttention } from '@/lib/auth/adminTrainers'
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const pendingTrainerCount = await countAdminTrainerApplicationsRequiringAttention(
