        ...
        exercises: [
          {
            ...
            exercise: { is_public: true, name: 'Sentadilla con barra', muscle_groups: ['Piernas'], equipment: ['Barra'] },
          },
          {
            ...
            exercise: { is_public: true, name: 'Peso muerto rumano', muscle_groups: ['Isquiotibiales'], equipment: ['Barra'] },
          },
        ],
      },
      {
        ...
        exercises: [{
          ...
          rest_seconds: 60, notes: null,
          exercise: { is_public: true, name: 'Prensa inclinada', muscle_groups: ['Cuádriceps'], equipment: ['Máquina'] },
        }],
      },
    ]}
    options={[
