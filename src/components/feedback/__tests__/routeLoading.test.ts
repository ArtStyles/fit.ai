...
describe('route loading skeletons', () => {
  it('keeps product notification loading icons inside a no-props client boundary', () => {
    ...
    expect(html).toContain('Avisos y novedades de tu cuenta')
    expect(html).toContain('h-11 w-11')
    expect(html).toContain('h-10 w-10')
    expect(html).toContain('lucide-bell h-5 w-5')
    expect(html).toContain('max-w-4xl')
    expect(html).toContain('data-loading-slot="notification-preferences"')
    expect(html).toContain('data-loading-slot="notification-summary"')
    expect(html).toContain('data-loading-slot="notification-attention"')
