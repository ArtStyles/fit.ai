...
Rollback: conservar datos/migraciones 040–047 y corregir solo hacia delante; no restaurar la sustracción defectuosa de días, no borrar tablas ni auditoría. Seguir [Respuesta a incidentes y Rollback](./trainer-marketplace-runbook.md#respuesta-a-incidentes).
...
|---|---|---|---|---|
| Migraciones 040–047, preflight 47 y divergencias ISO profesionales 0 |  |  |  |  |
| Journey E2E real |  |  |  |  |
