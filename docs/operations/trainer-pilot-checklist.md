...
- [ ] Verificar respaldo/restauración, preflight 45, matriz de autorización, seguridad x3, accesibilidad, build, auditoría y journey E2E conforme al [runbook](./trainer-marketplace-runbook.md).
- [ ] Ejecutar `pnpm test:db:marketplace` en base Docker fresca y, solo después del preflight remoto 45, `pnpm test:e2e:trainer-marketplace`; no usar el Playwright genérico ni reutilizar un servidor existente para este journey destructivo.
...
Rollback: volver al despliegue anterior compatible y conservar datos/migraciones 040–045; no borrar tablas ni auditoría. Seguir [Respuesta a incidentes y Rollback](./trainer-marketplace-runbook.md#respuesta-a-incidentes).
...
|---|---|---|---|---|
| Migraciones 040–045 y preflight 45 |  |  |  |  |
| Journey E2E real |  |  |  |  |
