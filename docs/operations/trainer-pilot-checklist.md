...
- [ ] Verificar respaldo/restauración, migraciones 040–049, `trainer_security_preflight() = 49`, divergencias ISO profesionales `= 0`, matriz de autorización, seguridad x3, accesibilidad, build, auditoría y journey E2E conforme al [runbook](./trainer-marketplace-runbook.md).
...
Rollback: conservar datos/migraciones 040–049 y corregir solo hacia delante; no restaurar la sustracción defectuosa de días, no borrar tablas ni auditoría. Seguir [Respuesta a incidentes y Rollback](./trainer-marketplace-runbook.md#respuesta-a-incidentes).
...
|---|---|---|---|---|
| Migraciones 040–049, preflight 49 y divergencias ISO profesionales 0 |  |  |  |  |
| Journey E2E real |  |  |  |  |
